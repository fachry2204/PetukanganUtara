                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6">
                           ...
                           <section>
                              ...
                              <div className={`p-4 rounded-2xl border flex items-center justify-between ${selectedTask.status === 'Verified' || selectedTask.status === 'Laporan Selesai' ? 'bg-emerald-50 border-emerald-100 text-emerald-700' : 'bg-orange-50 border-orange-100 text-orange-700'
                                 }`}>
